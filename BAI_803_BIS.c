...
void HT_DS1307()
{
   ...
   lcd_hienthi_so_z_toado_xy (GIAY_DS13 / 16, 0, 11);
   lcd_hienthi_so_z_toado_xy (GIAY_DS13 % 16, 0, 14);
   
   lcd_hienthi_so_z_toado_xy (NGAY_DS13 / 16, 1, 7);
   lcd_hienthi_so_z_toado_xy (NGAY_DS13 % 16, 1, 14);
   
   lcd_hienthi_so_z_toado_xy (THANG_DS13 / 16, 1, 11);
   lcd_hienthi_so_z_toado_xy (THANG_DS13 % 16, 1, 14);
}
